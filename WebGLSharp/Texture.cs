...
namespace WebGLSharp
{
    public class Texture
    {
        ...
        public static async Task<Texture> BuildAsync(WebGLContext gl, int[] image)
        {
            ...
            await gl.TexImage2DAsync<int>(Texture2DType.TEXTURE_2D, 0, PixelFormat.RGBA, 10, 10, PixelFormat.RGBA, PixelType.UNSIGNED_BYTE, image);
